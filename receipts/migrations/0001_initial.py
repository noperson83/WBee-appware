    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_of_purchase",
                    models.DateField(help_text="Date of purchase (YYYY-MM-DD format)"),
                ),
                (
                    "company_name",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="receipts_re_date_of_d8f433_idx",
                    ),
                    models.Index(
                        fields=["project"], name="receipts_re_project_0df9b9_idx"
                    ),
                    models.Index(
                        fields=["worker"], name="receipts_re_worker__252532_idx"
                    ),
                    models.Index(
                        fields=["purchase_type"], name="receipts_re_purchas_9bd02c_idx"
                    ),
                ],
            },
        ),
