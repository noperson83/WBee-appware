...
class PurchaseType(TimeStampedModel):
    """Different types of purchases that can be customized per company."""
...
class Receipt(TimeStampedModel):
    """Receipt model for expense tracking."""
    ...
    def get_absolute_url(self) -> str:
        """URL to access this receipt's detail view."""
        return reverse("receipt-detail", args=[str(self.id)])

    @property
    def is_recent(self) -> bool:
        """Return True if the receipt is from the last 30 days."""
