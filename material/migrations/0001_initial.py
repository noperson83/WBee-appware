    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_name",
                    models.CharField(
                        db_index=True, help_text="Manufacturer name", max_length=200
                    ),
                ),
                (
                    "manufacturer_code",
                    models.CharField(
                        help_text="Short code (MFG001, etc.)",
                        max_length=20,
                        unique=True,
                    ),
                ),
                ...
                (
                    "warranty_terms",
                    models.TextField(blank=True, help_text="Standard warranty terms"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Devices, Wire, Food Items, Medical Supplies, etc.",
                        max_length=100,
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of this product category"
                    ),
                ),
                (
                    "icon",
                ...
                (
                    ...
                    models.CharField(
                        default="each", help_text="Default UOM", max_length=20
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "upc_code",
                    models.CharField(
                        blank=True, help_text="UPC/Barcode", max_length=20
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, help_text="Units per package/box"
                    ),
                ),
                (
                    "weight",
                ...
                (
                    "weight_unit",
                    models.CharField(
                        default="lbs", help_text="Weight unit", max_length=10
                    ),
                ),
                (
                    "length",
                ...
                (
                    "dimension_unit",
                    models.CharField(
                        default="inches", help_text="Dimension unit", max_length=10
                    ),
                ),
                ("track_inventory", models.BooleanField(default=True)),
                (
                ...
                (
                    "product_url",
                    models.URLField(blank=True, help_text="Manufacturer product page"),
                ),
                (
                    "datasheet_url",
                    models.URLField(blank=True, help_text="Technical datasheet URL"),
                ),
                (
                    "installation_guide_url",
                    models.URLField(blank=True, help_text="Installation guide URL"),
                ),
                (
                    "is_billable",
                    models.BooleanField(
                        default=True, help_text="Can this product be billed to clients?"
                    ),
                ),
                (
                    "is_purchasable",
                    models.BooleanField(
                        default=True, help_text="Can this product be purchased?"
                    ),
                ),
                (
                    "is_sellable",
                    models.BooleanField(
                        default=True, help_text="Can this product be sold?"
                    ),
                ),
                (
                    "custom_fields",
                    models.JSONField(
                        blank=True, default=dict, help_text="Custom product data"
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_name",
                    models.CharField(
                        db_index=True, help_text="Supplier company name", max_length=200
                    ),
                ),
                (
                    "supplier_code",
                    models.CharField(
                        help_text="Short code (SUP001, ACME, etc.)",
                        max_length=20,
                        unique=True,
                    ),
                ),
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Supplier description", max_length=2000
                    ),
                ),
                (
                    "logo",
                ...
                (
                    "contract_details",
                    models.TextField(
                        blank=True, help_text="Contract terms and details"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company_name"], name="material_su_company_074600_idx"
                    ),
                    models.Index(
                        fields=["supplier_type"], name="material_su_supplie_5b3456_idx"
                    ),
                    models.Index(
                        fields=["is_active", "is_preferred"],
                        name="material_su_is_acti_937720_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lead_time_days",
                    models.PositiveIntegerField(
                        default=7, help_text="Lead time in days"
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                related_name="products",
                through="material.ProductSupplier",
                to="material.supplier",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Who created this transaction",
                        max_length=100,
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["category", "is_active"], name="material_pr_categor_0e4be6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["manufacturer"], name="material_pr_manufac_cd62bc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["current_stock"], name="material_pr_current_7c1bf8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["minimum_stock"], name="material_pr_minimum_3a30a9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturer",
            index=models.Index(
                fields=["company_name"], name="material_ma_company_63059c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturer",
            index=models.Index(
                fields=["is_active"], name="material_ma_is_acti_75e102_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="material_in_product_d93e58_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="inventorytransaction",
            index=models.Index(
                fields=["created_at"], name="material_in_created_8f47f3_idx"
            ),
        ),
    ]
